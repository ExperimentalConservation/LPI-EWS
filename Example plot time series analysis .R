...
pdf("~/Desktop/LivingPlanet index early warnings/plots/Example ews plots.pdf",width=4, height=9)
	...
	plot(time.series$x, time.series$y, type="n", xlab="", ylab="Abundance", xaxt="n", xlim=c(0, 23.5), ylim=c(0, 150))
	...
	polygon(x=c(17,22, 22, 17),y=c(-10, -10, 170, 170), col= adjustcolor("grey ",alpha=0.6), lty=0)
	...
	plot(time.series$x, time.series$ar1, type="n", xlab="Time", ylab="ar1", xaxt="n", xlim=c(0, 23.5), ylim=c(-0.9, 1.3))
	polygon(x=c(10,15, 15, 10),y=c(-10, -10, 170, 170), col= adjustcolor("darkgoldenrod2 ",alpha=0.4), lty=0)
	lines(time.series$x, time.series$ar1, type="b")
	...
	plot(comp.ews$time, comp.ews$metric.score, type="n", col="skyblue3", ylim=c(0, 7), lwd=2, xaxt="n", ylab="Composite EWS", xlim=c(0, 23.5))
	polygon(x=c(10,15, 15, 10),y=c(-10, -10, 170, 170), col= adjustcolor("darkgoldenrod2 ",alpha=0.4), lty=0)
	...
	polygon(x=c(17,22, 22, 17),y=c(-10, -10, 170, 170), col= adjustcolor("grey ",alpha=0.6), lty=0)
	legend("topleft", legend=c("Running mean", 
	...
	gam.comp<-gam_smoothing(comp.ews$time[!is.na(comp.ews$metric.score)], 
							...
							6)
	plot(comp.ews$time, comp.ews$metric.score, type="n", col="skyblue3", ylim=c(0, 7), lwd=2, xlab="Time", ylab="Composite EWS", xlim=c(0, 23.5))
	polygon(x=c(10,15, 15, 10),y=c(-10, -10, 170, 170), col= adjustcolor("darkgoldenrod2 ",alpha=0.4), lty=0)
	lines(comp.ews$time, comp.ews$metric.score, type="l", col="skyblue3", lwd=2)
